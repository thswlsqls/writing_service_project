...
<div class="container">
   ...
   <div class="col-6 alignLeft" style="position: relative;">
   <div class="contents fontcss" >
      <ul>
         <li><a  href="controller?cmd=bookmarkListUI" class='aTag'>즐겨찾기</a></li>
         <li><a href="controller?cmd=myPageUI" class='aTag'>나의글</a></li>
...
<div class="container">
   ...
   <div class="row fontcss" style="text-align: center;">
      <div class="col-6" ><strong>팔로우목록</strong></div>
      <div class="col-6" >
