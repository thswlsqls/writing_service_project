...
<!-- <nav class=" navbar fixed-top navbar-expand-sm navbar-dark HAYheader ">
  ...
  <!-- 부트스트랩4버전 네비바로 대체함 -->
<nav class="navbar navbar-expand-md  navbar-light HAYheader fixed-top">
  <a class="navbar-brand linkText" href="controller?cmd=homeUI">How Are You</a>
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
      ...
      <li class="nav-item linkText">
        <a class="nav-link " href="controller?cmd=rankingUI">RANKING</a>
      </li>
      <li class="nav-item linkText">
        <a class="nav-link " href="controller?cmd=newListUI">NEW</a>
      </li>    
      <li class="nav-item linkText">
        <a class="nav-link " href="controller?cmd=trendUI">TREND</a>
      </li>    
    </ul>
  </div>  
</nav>
